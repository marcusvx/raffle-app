...
/******/ 	return __webpack_require__(__webpack_require__.s = "./tickets-read-all.js");
/******/ })
/************************************************************************/
/******/ ({
...
const q = faunadb__WEBPACK_IMPORTED_MODULE_0__["query"];
function handler(event, context) {
  console.log("Function `ticket-read-all` invoked");
  const client = new faunadb__WEBPACK_IMPORTED_MODULE_0__["Client"]({
    secret: process.env.FAUNADB_SERVER_SECRET
  });
  return client.query(q.Paginate(q.Match(q.Ref("indexes/all_tickets_sort_by_value")), {
    size: 100
  })).then(response => {
